...
const Explore = () => {
    ...
    if (!user) return (
        <div className="container flex-center animate-fade-in" style={{ minHeight: '80vh', flexDirection: 'column', textAlign: 'center', padding: '2rem 1rem' }}>
            <div className="glass-card" style={{ maxWidth: '400px', width: '100%', padding: '2rem' }}>
                ...
                <h2 style={{ fontSize: '1.75rem', marginBottom: '1rem' }}>Unlock <span className="premium-gradient-text">HackMate</span></h2>
        ...
        <div className="container animate-fade-in" style={{ paddingTop: '4rem', paddingBottom: '6rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1.5rem' }}>
                <div style={{ flex: '1 1 300px' }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '0.5rem', lineHeight: 1.2 }}>
                        Find your next <span className="premium-gradient-text">challenge.</span>
                    </h2>
                    <p style={{ color: 'var(--text-muted)', fontSize: '1rem' }}>
                        Explore hackathon projects looking for your skills.
                    </p>
                </div>
