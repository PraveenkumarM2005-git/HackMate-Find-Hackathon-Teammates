        ...
        <div className="animate-fade-in">
            ...
            <section style={{
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <Link to="/explore" className="btn-primary" style={{ fontSize: '1rem', padding: '0.8rem 1.6rem', width: 'auto' }}>
                        Find a Team
                    </Link>
                    <Link to="/create" className="btn-outline" style={{ fontSize: '1rem', padding: '0.8rem 1.6rem', width: 'auto' }}>
                        Post a Project
                    </Link>
                </div>
            </section>
